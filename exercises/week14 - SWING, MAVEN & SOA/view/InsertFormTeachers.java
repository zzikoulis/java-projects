...
public class InsertFormTeachers extends JFrame {
	...
	public InsertFormTeachers() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(InsertFormTeachers.class.getClassLoader().getResource("eduv2.png")));
		...
		btnInsert.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					teacherDTO.setSname(txtSname.getText().trim());
					teacherDTO.setFname(txtFname.getText().trim());
		...
		btnClose.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeachersStudentsApp.getInsertFormTeachers().setVisible(false);
			}
		});
