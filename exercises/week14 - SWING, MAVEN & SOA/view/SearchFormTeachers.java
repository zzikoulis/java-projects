...
public class SearchFormTeachers extends JFrame {
	...
	public SearchFormTeachers() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(SearchFormTeachers.class.getClassLoader().getResource("eduv2.png")));
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeachersStudentsApp.getUpdateDeleteFormTeachers().setLastname(inputLastname);
				TeachersStudentsApp.getSearchFormTeachers().setEnabled(false);
				TeachersStudentsApp.getUpdateDeleteFormTeachers().setVisible(true);
			}
		});
		...
		btnInsert.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				TeachersStudentsApp.getSearchFormTeachers().setEnabled(false);
				TeachersStudentsApp.getInsertFormTeachers().setVisible(true);
			}
		});
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TeachersStudentsApp.getSearchFormTeachers().setVisible(false);
			}
		});
